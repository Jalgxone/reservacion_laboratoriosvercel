...
- `app/Views` - vistas 
- `core` - núcleo 
- `config` - configuración básica (`config.php`)

- Integrantes
`Albert Rivas` *Frontend & UX Engineer*
`Jesus Noguera` *Data Specialist*
`Jose Lopez`*Backend Architect-Integration Specialist*             
`Chukwudubem onoh` *QA & Documentation Lead*
